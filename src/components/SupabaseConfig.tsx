...
export default function SupabaseConfig({ onSync }: SupabaseConfigProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Status Badge */}
      <div className={`flex items-center gap-2 p-3 rounded-xl border ${getStatusColor()}`}>
        {getStatusIcon()}
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500"
          />
        </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {syncing ? (
      ...
      <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30">
        ...
        <ol className="text-sm text-gray-600 dark:text-gray-300 space-y-1 list-decimal list-inside">
          <li>Acesse <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">supabase.com</a> e crie uma conta gratuita</li>
          <li>Crie um novo projeto e aguarde a inicialização</li>
          <li>Vá em <strong>SQL Editor</strong> e execute o script do arquivo <code className="px-1 py-0.5 bg-gray-200 dark:bg-white/10 rounded">database.sql</code></li>
      ...
      {/* How to verify data */}
      <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30">
        <h4 className="font-medium text-emerald-600 dark:text-emerald-400 mb-2">🔍 Como verificar os dados no Supabase:</h4>
        <ol className="text-sm text-gray-600 dark:text-gray-300 space-y-1 list-decimal list-inside">
